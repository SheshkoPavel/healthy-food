...
export const T13SmallSizeCardsMenu = ({ data }: any) => {
  const {
    visible,
    title,
    headline_copy,
  ...
  return (
    <>
      <div className="p-template-13-menu__section" id={section_anchor} data-testid='menu small cards'>
        <div className="p-template-13-menu__section-header">
          <h3 className="p-template-13-menu__section-title" data-testid='menu small cards title'>
            {title}
          </h3>
          {headline_copy && <div className="p-template-13-menu__section-descriprion" data-testid='menu small cards descriprion'>
            <RichText text={headline_copy} />
          </div>}
        </div>

        <div className="p-template-13-menu__section-preview-cards">
          {
            items.map((menuItem, index: number) => {
              return (
                <div key={index} className="c-content-card c-content-card--small c-content-card--static" data-testid='menu small cards item'>
