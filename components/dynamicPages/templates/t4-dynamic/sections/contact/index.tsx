...
import { T4ClubContactMainContent } from '@/types';

export const T4ContactSection = ({ data }: any) => {
  const {
    visible,
    item = [],
    title
  }: T4ClubContactMainContent = data;
        ...
        <div className="c-contact-information">
          ...
          <div className="c-contact-information__type-wrapper">
            {item.map((contact, index: number) => {
              ...
              return (
                <div className="c-contact-information__section" key={index} data-testid='contact card'>
